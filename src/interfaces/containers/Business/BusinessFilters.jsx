import { ChevronDownIcon, ChevronUpIcon, MagnifyingGlassCircleIcon } from '@heroicons/react/24/solid';
import React, { useState } from 'react';
import IconButton from '../../components/IconButton';

const BusinessFilters = ({setFilters}) => {
        ...
        <>
            ...
            {showFilters &&
                <form className="w-full flex flex-wrap gap-4 items-center">
                    ...
                    <div className='filter-input-box'>
                        <label> Direccion Central </label>
                        <input type="text" placeholder='Servicio' name='inpDescription' />
                    </div>

                    <IconButton
                        action={handleSearch}
                        Icon={<MagnifyingGlassCircleIcon className="icon"/> }
                        text={"Buscar"}
